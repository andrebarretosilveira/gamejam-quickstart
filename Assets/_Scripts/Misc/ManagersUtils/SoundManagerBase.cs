...
public static class SoundManagerExtensions
{
    ...
    {
        SoundManagerBase.PlayOneShotSound(source, clip, 1.0f);
    }
    ...
    {
        SoundManagerBase.PlayOneShotSound(source, clip, volumeScale);
    }
    ...
    {
        SoundManagerBase.PlayOneShotMusic(source, clip, 1.0f);
    }
    ...
    {
        SoundManagerBase.PlayOneShotMusic(source, clip, volumeScale);
    }
    ...
    {
        SoundManagerBase.PlayLoopingSound(source, 1.0f, 1.0f);
    }
    ...
    {
        SoundManagerBase.PlayLoopingSound(source, volumeScale, fadeSeconds);
    }
    ...
    {
        SoundManagerBase.PlayLoopingMusic(source, 1.0f, 1.0f, false);
    }
    ...
    {
        SoundManagerBase.PlayLoopingMusic(source, volumeScale, fadeSeconds, persist);
    }
    ...
    {
        SoundManagerBase.StopLoopingSound(source);
    }
    ...
    {
        SoundManagerBase.StopLoopingMusic(source);
    }
}
...
public class SoundManagerBase : MonoBehaviour
{
    ...
    private static SoundManagerBase instance;
    ...
    private static void EnsureCreated()
    {
        if (needsInitialize)
        {
            ...
            instance = root.AddComponent<SoundManagerBase>();
    ...
    {
        if (SoundManagerBase.PauseSoundsOnApplicationPause)
        {
            if (paused)
            {
                SoundManagerBase.ResumeAll();
            }
            else
            {
                SoundManagerBase.PauseAll();
            }
        }
    }
